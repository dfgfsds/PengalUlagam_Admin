...
function BlogModal({ open, close, userId, editData }: any) {
    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            ...
            if (editData) {
                ...
                const createApi = await postBlogsApi("", {
                    ...payload,
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-30 flex justify-center items-center">
            <div
                className="bg-white p-6 rounded-md w-full max-w-lg max-h-[96vh] overflow-y-auto"
            ...
            >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button
                            type="submit"
                            className="px-4 py-2 bg-[#a8822d] text-white rounded hover:bg-[#a8822d]"
                        >
                            Submit
                        </button>
                    </div>
