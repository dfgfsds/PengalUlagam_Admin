...
import { Settings, Package, ShoppingCart, Users, User, FolderTree, Megaphone, BarChart, Image, Ticket, Library, Star, Navigation } from 'lucide-react';
...
export default function StoreNav() {
  ...
  const links = [
    ...
    // { to: `/store/${id}/reviews`, icon: Star, label: 'Reviews' },
        { to: `/store/${id}/referrel`, icon: Navigation, label: 'Referrels' },
  ];
